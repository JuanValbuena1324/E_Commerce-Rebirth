    ...
    return (
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex items-center justify-center">
          <p className="font-cinzel">Producto no encontrado</p>
        </div>
        <Footer />
      </div>
    );
      ...
      <div className="flex-1 flex flex-col items-center px-4 md:px-8 py-10 md:py-12">
        ...
        {step === 1 && (
          <div className="flex flex-col items-center w-full max-w-[360px]">
            <div onClick={() => fileRef.current?.click()} className="w-full border border-brand-light bg-white flex flex-col items-center justify-center p-6 md:p-8 cursor-pointer hover:border-brand-black transition-colors">
            ...
            <p className="font-cinzel text-[9px] tracking-[0.1em] uppercase text-brand-mid text-center mt-4">
          ...
          <div className="flex flex-col items-center w-full max-w-[360px]">
            ...
            <div className="w-full border border-brand-light bg-white p-5 md:p-6">
              <div className="relative w-full h-[260px] md:h-[300px] bg-brand-offwhite mb-3">
                <img src={generatedImageUrl} alt="Try-on result" className="w-full h-full object-cover" />
              </div>
              <p className="font-cinzel text-[9px] tracking-[0.2em] uppercase text-brand-mid mb-4">AI Generated Preview</p>
              <div className="flex gap-3">
                <button onClick={addToCart} className="flex-1 py-3 bg-brand-black text-white font-cinzel text-[9px] tracking-[0.15em] uppercase border border-brand-black hover:bg-brand-carbon">
                  Add To Cart
                </button>
                <button onClick={resetTryOn} className="flex-1 py-3 bg-transparent text-brand-black font-cinzel text-[9px] tracking-[0.15em] uppercase border border-brand-black hover:bg-brand-black hover:text-white">
                  Try Again
                </button>
              </div>
            </div>
