      ...
      <div className="flex-1 flex flex-col items-center px-4 md:px-8 py-10 md:py-12">
        ...
        {step === 1 && (
          <div className="flex flex-col items-center w-full max-w-[360px]">
            <div onClick={() => fileRef.current?.click()} className="w-full border border-brand-light bg-white flex flex-col items-center justify-center p-6 md:p-8 cursor-pointer hover:border-brand-black transition-colors duration-200">
          ...
          <div className="flex flex-col items-center w-full max-w-[360px]">
            ...
            <div className="w-full border border-brand-light bg-white p-5 md:p-6">
              ...
              <div className="flex gap-3">
                <button onClick={addToCart} className="flex-1 py-3 bg-brand-black text-white font-cinzel text-[9px] tracking-[0.15em] uppercase border border-brand-black hover:bg-brand-carbon transition-colors">
                  Add To Cart
                </button>
                <button onClick={resetTryOn} className="flex-1 py-3 bg-transparent text-brand-black font-cinzel text-[9px] tracking-[0.15em] uppercase border border-brand-black hover:bg-brand-black hover:text-white transition-all">
                  Try Again
                </button>
              </div>
            </div>
